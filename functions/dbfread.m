...
% User: Yuk
% Post: https://stackoverflow.com/questions/2112932/how-to-open-dbase-files-dbf-in-matlab/2366148#2366148
% Date: Mar 2, 2010
% Comment: I contacted with Brian Madsen, the author of DBFREAD function, which 
% was deleted from File Exchange, probably because The Mathworks is going to 
% include this function into MATLAB in some future release. Brian kindly gave me
% permission to publish this function here. All copyright information left 
% intact. I only modified lines 33-38 to allow DBFREAD to read file outside 
% working directory.
% Date Accessed: Mar 6, 2025
